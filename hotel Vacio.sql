...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-10-2024 a las 05:41:02
...
--
ALTER TABLE `habitaciones`
  ADD CONSTRAINT `habitaciones_ibfk_1` FOREIGN KEY (`id_hotel`) REFERENCES `hotel` (`id_hotel`) ON DELETE CASCADE;
...
ALTER TABLE `reservas`
  ...
  ADD CONSTRAINT `reservas_ibfk_3` FOREIGN KEY (`id_hotel`) REFERENCES `hotel` (`id_hotel`) ON DELETE CASCADE;
COMMIT;
